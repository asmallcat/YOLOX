...
# csv格式转coco格式，隔10帧取训练集验证集和测试集
# io_dic = {'/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/COCO-format/train10.json':
#               open('/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/train10.csv', 'r').readlines(),
#           '/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/COCO-format/val10.json':
#               open('/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/val10.csv', 'r').readlines(),
#           '/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/COCO-format/test10.json':
#               open('/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/test10.csv', 'r').readlines(),
#           }

# io_dic = {'/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/COCO-format/trainall.json':
#               open('/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/trainall.csv', 'r').readlines(),
#           '/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/COCO-format/testall.json':
#               open('/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/testall.csv', 'r').readlines(),
#           '/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/COCO-format/valall.json':
#               open('/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/valall.csv', 'r').readlines(),
#           }

# 隔10帧取训练集，验证集后面从训练集中随机划分
# io_dic = {'/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/COCO-format/train10all.json':
#               open('/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/train10all.csv', 'r').readlines(),
#           }

# 选取特定数据集做验证集，验证集没有隔帧取
io_dic = {'/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/COCO-format/val_all.json':
              open('/home/lxz-2/CZ/project/CenterNet/data/UA-Detrac/val_all.csv', 'r').readlines(),
          }
DEBUG = False
